...
public class MainActivity extends AppCompatActivity implements
        ForecastAdapter.ForecastAdapterOnClickHandler, LoaderCallbacks<String[]> {
    ...
    public Loader onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                try{
                    String jsonWeatheResponse = NetworkUtils.getResponseFromHttpUrl(weatherURL);
                    String [] simpleJsonWeatherdata = OpenWeatherJsonUtils.
                            getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatheResponse);
